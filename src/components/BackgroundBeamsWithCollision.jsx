...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    ...
    <div
      ref={parentRef}
      className={cn(
        "h-96 md:h-full bg-gradient-to-tl from-[#623a8a] to-[#0d0317] relative flex items-center w-full justify-center overflow-hidden",
        // h-screen if you want bigger
        className
      )}>

      <div className='fixed inset-0 opacity-55'>
